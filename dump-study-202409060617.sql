...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='게시판';
...
INSERT INTO `board` VALUES (1,1,'테스트 공지 사항','테스트 내용','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(2,2,'테스트 상담 요청','상담 요청 내용','22020401',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,3,'테스트 공지사항2222','테스트 공지사항2 내용','admin1',0,NULL,'2024-08-23 10:55:18','2024-09-06 06:07:59'),(1,5,'테스트 공지사항44444111','테스트 공지사항444444 내용213','admin1',0,NULL,'2024-08-23 13:44:18','2024-09-06 05:50:38'),(1,10,'테스트 aa공지사항3','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,11,'테스트 공지사항4','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,12,'테스트 공지사항5','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,13,'테스트 aa공지사항6','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,14,'테스트 공지사항7','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,15,'테스트 공지사항8','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,16,'테스트 공지사항9','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,17,'테스트 공지사항10','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,18,'11111111111111','222222222222222','admin1',1,NULL,'2024-09-06 06:12:31','2024-09-06 06:12:31'),(1,19,'44444444444','445555555555555','admin1',1,NULL,'2024-09-06 06:13:01','2024-09-06 06:13:01');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='학생 게시판';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `board_student_requests` VALUES (3,2,0);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='학급 교직원 구성원';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='반 학생 구성원';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='학년반';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `exam` (
  ...
  `classSection` int(11) DEFAULT NULL COMMENT '반',
  `classroom_id` int(11) DEFAULT NULL COMMENT 'classroom id',
  PRIMARY KEY (`exam_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='시험 정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `exam` VALUES (3,1,'1학기 중간고사','2024-09-03 09:13:22','2024-09-03 09:13:22',2020,1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='학생 시험 점수';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `exam_score` VALUES (1,3,3,'22020401',90,'2024-09-06 05:34:51','2024-09-06 05:34:51'),(2,3,3,'22020402',85,'2024-09-03 13:53:34','2024-09-03 13:53:34'),(3,3,3,'22020403',70,'2024-09-03 13:53:34','2024-09-03 13:53:34'),(4,4,3,'22020401',80,'2024-09-06 05:34:51','2024-09-06 05:34:51'),(5,5,3,'22020401',100,'2024-09-06 05:34:51','2024-09-06 05:34:51'),(6,4,3,'22020402',70,'2024-09-03 13:53:34','2024-09-03 13:53:34'),(7,5,3,'22020402',90,'2024-09-03 13:53:34','2024-09-03 13:53:34'),(8,6,3,'22020401',88,'2024-09-06 05:34:51','2024-09-06 05:34:51'),(9,7,3,'22020401',75,'2024-09-06 05:34:51','2024-09-06 05:34:51'),(10,8,3,'22020401',90,'2024-09-06 05:34:51','2024-09-06 05:34:51'),(11,9,3,'22020401',1,'2024-09-06 05:34:51','2024-09-06 05:34:51');
...
CREATE TABLE `exam_subject` (
  ...
  KEY `exam_subject_FK` (`exam_id`),
  CONSTRAINT `exam_subject_FK` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`exam_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='시험 과목';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `exam_subject` VALUES (3,3,'MAT'),(4,3,'KOR'),(5,3,'ENG'),(6,3,'PHY'),(7,3,'CHE'),(8,3,'BIO'),(9,3,'ESS');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='맴버';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='refresh token';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci COMMENT='과목';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-06  6:18:00
