    ...
    <div class="reports-wrapper">
        <v-row>
            <v-col cols="12" md="3" class="year-list">
                <div v-for="(item, tIdx) in testInfo" @click="getTest(item)" class="item">
            ...
            <v-col cols="12" md="9">
                <div class="d-flex justify-space-between">
                    ...
                    <div>
                        <v-btn v-if="!isModify" @click="modifyReport" small color="error"
                            >성적 입력</v-btn
                        >
                        <v-btn v-else @click="updateReport" small color="success">입력 완료</v-btn>
                    </div>
                </div>
                <table>
                    <thead>
