...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COMMENT='게시판';
...
INSERT INTO `board` VALUES (1,1,'테스트 공지 사항','테스트 내용','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(2,2,'테스트 상담 요청','상담 요청 내용','24010101',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,3,'테스트 공지사항2','테스트 공지사항2 내용','admin1',1,NULL,'2024-08-23 10:55:18','2024-08-23 10:55:18'),(1,5,'테스트 공지사항44444','테스트 공지사항444444 내용','admin1',1,NULL,'2024-08-23 13:44:18','2024-08-23 13:44:54'),(1,10,'테스트 aa공지사항3','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,11,'테스트 공지사항4','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,12,'테스트 공지사항5','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,13,'테스트 aa공지사항6','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,14,'테스트 공지사항7','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,15,'테스트 공지사항8','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,16,'테스트 공지사항9','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00'),(1,17,'테스트 공지사항10','테스트 내용3333333333','admin1',1,NULL,'2020-01-01 00:00:00','2020-01-01 00:00:00');
...
CREATE TABLE `exam` (
  ...
  `mod_date` datetime NOT NULL COMMENT '수정일',
  PRIMARY KEY (`exam_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='시험 정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `exam` VALUES (3,1,'1학기 중간고사','2024-09-03 09:13:22','2024-09-03 09:13:22');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='학생 시험 점수';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `exam_score` VALUES (1,3,3,'22020401',90,'2024-09-03 13:53:34','2024-09-03 13:53:34');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='시험 과목';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `exam_subject` VALUES (3,3,'MAT','staff1','2022-04-05',2,90,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb4 COMMENT='refresh token';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-03 16:33:20
